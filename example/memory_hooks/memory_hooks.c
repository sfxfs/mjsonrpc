...
int main(void)
{
    ...
    const char* request_str =
        "{\"jsonrpc\":\"2.0\",\"method\":\"hello\",\"params\":{\"name\":\"Alice\"},\"id\":1}";
    int ret_code;
    ...
    {
        printf("Response: %s\n", response_str);
        free(response_str); // This uses standard free since mjrpc_process_str uses standard memory
